<?php echo $this->Form->create('WikiPage', array('class'=>'form-inline','url' => array('controller' => 'WikiPages', 'action' => 'view'))); ?>

<?php echo $this->Form->input('keyword', array('label' => false,'placeholder'=>'ページを検索', 'class' => 'form-control input-sm', 'div' => 'form-group')); ?>
<button type="submit" class="btn btn-default btn-sm" style="margin:0px 5px;">検索</button>
</form>
